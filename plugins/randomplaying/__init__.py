...
excel_file = pd.ExcelFile(os.path.join(current_file_dir, 'playing.xlsx'))
...
def random_meal():
    ...
    res = '建议您去'+ str(canteen) + '玩捏~'
    return res

guess = on_command("去哪玩", block=True, permission=GROUP_MEMBER|PRIVATE|GROUP)
